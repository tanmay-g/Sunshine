...
//
///**
// * Created by Tanmay.godbole on 25-07-2016.
// */
...
//            locationQuery = intent.getStringExtra(LOCATION_QUERY_EXTRA);
//        else
//            return;
...
//            context.startService(new Intent(context, SunshineService.class).putExtra(
